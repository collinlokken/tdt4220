...
public class Player extends Entity
{
    ...
    {
        super(position, new HitboxComponent(15, 20, position), new ShieldConsumerComponent(),new VelocityComponent(0, 0),new HealthComponent(3, 3), new ShieldConsumerComponent(), new GravityComponent(20*9.81f),new ScoreComponent(0));
